...
logo=(green+""" \n\x1b[1;91m<<------------------------------------------------->>\n\x1b[1;93m\xe2\x9e\xa3 Author   : TEAM KHAN   \n\x1b[1;93m\xe2\x9e\xa3 Facebook page : khan white hat hackers team  \n\x1b[1;93m\xe2\x9e\xa3 Facebook group : khan white hat hackers team \n\x1b[1;93m\xe2\x9e\xa3 Github:- khan white hat hackers team \n\x1b[1;91m<<-------------------------------------------------->>\n
...
dtls=(yellow+"\t\t KHAN WHITE HAT HACKERS TEAM ")
...
for i in range (amount):
	...
	print(str(i+1)+green+'.	➙ Succesfully SMS sent 😈✅')
	
print('					')
print(cyan+'\t\tThanks For Using RedBomber Bangladesh KHAN WHITE HAT HACKERS TEAM - ')
